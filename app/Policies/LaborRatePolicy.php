...
class LaborRatePolicy
{
     ...
     */
    public function view(User $user, LaborRate $camoRate): bool
    {
        return $user->hasAnyRole(['admin', 'super-admin']) && $user->can('read-rate');
    }
     ...
     */
    public function update(User $user, LaborRate $camoRate): bool
    {
     ...
     */
    public function delete(User $user, LaborRate $camoRate): bool
    {
     ...
     */
    public function restore(User $user, LaborRate $camoRate): bool
    {
        return $user->hasAnyRole(['admin', 'super-admin']) && $user->can('delete-rate');
    }
     ...
     */
    public function forceDelete(User $user, LaborRate $camoRate): bool
    {
