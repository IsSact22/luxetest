...
class BrandAircraftController extends Controller
{
    ...
    {
        try {
            $this->authorize('view', BrandAircraft::class);
    ...
    {
        try {
            $this->authorize('update', BrandAircraft::class);
            $this->brandAircraftRepository->updateBrandAircraft($request->all(), $id);
    ...
    {
        try {
            $this->authorize('delete', BrandAircraft::class);
