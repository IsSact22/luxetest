    ...
    <div @click="goToCamo" class="border rounded-md p-2 shadow hover:cursor-pointer hover:drop-shadow-md">
        ...
        <div>
            <div class="w-full bg-gray-200 overflow-hidden my-2">
                <div class="flex">
                    <div class="bg-violet-400 text-white py-2 text-xs text-center h-4 place-content-center" :style="{ width: `${getPercentage(statusCounts.in_progress)}%` }">{{getPercentage(statusCounts.in_progress)}}%</div>
                    <div class="bg-green-400 text-white py-2 text-xs text-center h-4 place-content-center" :style="{ width: `${getPercentage(statusCounts.completed)}%` }">{{getPercentage(statusCounts.completed)}}%</div>
                    <div class="bg-orange-400 text-white py-2 text-xs text-center h-4 place-content-center" :style="{ width: `${getPercentage(statusCounts.pending)}%` }">{{getPercentage(statusCounts.pending)}}%</div>
                </div>
            </div>

            <div class="grid grid-cols-3 gap-1">
                <div class="flex flex-col justify-items-center items-center border rounded-md p-4">
                    <span class="inline-block h-8 w-8 bg-violet-400 rounded-full p-1">
                ...
                <div class="flex flex-col justify-items-center items-center border rounded-md p-4">
                    <span class="inline-block h-8 w-8 bg-green-400 rounded-full p-1">
                ...
                <div class="flex flex-col justify-items-center items-center border rounded-md p-4">
                    <span class="inline-block h-8 w-8 bg-orange-400 rounded-full p-1">
