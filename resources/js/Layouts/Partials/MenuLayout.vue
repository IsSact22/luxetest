    ...
    <div class="mt-6 w-48">
        ...
        <div class="px-4">
            <nav class="flex flex-col justify-between items-start space-y-2">
                <!-- Navigation Links -->
                <Link :active="route().current('dashboard')" :href="route('dashboard')"
                ...
                <Link :active="route().current('clients.index')" :href="route('clients.index')"
                      class="flex flex-row justify-items-center items-center space-x-2">
                    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <Link :active="route().current('projects.index')" :href="route('projects.index')"
                      class="flex flex-row justify-items-center items-center space-x-2">
                    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
                ...
                <Link :active="route().current('users.index')" :href="route('aircraft.index')"
                      class="flex flex-row justify-items-center items-center space-x-2">
                    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
                ...
                <Link :active="route().current('services.index')" :href="route('services.index')"
                      class="flex flex-row justify-items-center items-center space-x-2">
                    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
                           stroke-linejoin="round" transform="translate(2 2)">
                ...
                <Link class="flex flex-row justify-items-center items-center space-x-2">
                    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
                           stroke-linejoin="round" transform="translate(1 4)">
                            <path d="m3.5 3.165h9"/>
                            <path
                                d="m4.48122025 6.20339509 1-.01878307c.5127454-.00963092.94259192.36840352 1.00968673.86456969l.00909302.13525035v.9832835c0 .54496455-.4363518.98958934-.98122025.99982364l-1 .01878306c-.5127454.00963093-.94259192-.36840352-1.00968673-.86456968l-.00909302-.13525396v-.98327989c0-.54496455.4363518-.98958935.98122025-.99982364z"/>
                            <path
                                d="m2.5.1507576h11c1.1045695 0 2 .8954305 2 2v10.0147186h-13c-1.1045695 0-2-.8954305-2-2v-8.0147186c0-1.1045695.8954305-2 2-2z"/>
                            <path d="m8.5 6.165h4"/>
                            <path d="m8.5 9.165h4"/>
                ...
                <Link :active="route().current('users.index')" :href="route('users.index')"
