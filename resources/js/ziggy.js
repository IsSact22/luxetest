const Ziggy = {
    "url": "http:\/\/localhost", "port": null, "defaults": {}, "routes": {
        ...
        "log-viewer.folders": {"uri": "log-viewer\/api\/folders", "methods": ["GET", "HEAD"]},
        ...
        "log-viewer.files.clear-cache-all": {"uri": "log-viewer\/api\/clear-cache-all", "methods": ["POST"]},
        ...
        "api.v1.login": {"uri": "api\/v1\/login", "methods": ["POST"]},
        "api.v1.logout": {"uri": "api\/v1\/logout", "methods": ["POST"]},
        "api.v1.users.byRole": {
            "uri": "api\/v1\/users\/{role}\/byRole",
            "methods": ["GET", "HEAD"],
            "parameters": ["role"]
        },
        "api.v1.users": {"uri": "api\/v1\/users", "methods": ["GET", "HEAD"]},
        "api.v1.users.store": {"uri": "api\/v1\/users", "methods": ["POST"]},
        "api.v1.users.update": {"uri": "api\/v1\/users", "methods": ["PUT", "PATCH"]},
        "api.v1.permissions.roles": {"uri": "api\/v1\/permissions\/roles", "methods": ["GET", "HEAD"]},
        "api.v1.permissions.roles.store": {"uri": "api\/v1\/permissions\/roles", "methods": ["POST"]},
        "api.v1.permissions.roles.update": {
            "uri": "api\/v1\/permissions\/{id}\/roles",
            "methods": ["PATCH"],
            "parameters": ["id"]
        },
        "api.v1.permissions.roles.delete": {
            "uri": "api\/v1\/permissions\/{id}\/roles",
            "methods": ["DELETE"],
            "parameters": ["id"]
        },
        "api.v1.permissions.assign": {
            "uri": "api\/v1\/permissions\/roles\/{id}\/{guard}\/assign",
            "methods": ["POST"],
            "parameters": ["id", "guard"]
        },
        "api.v1.permissions.revoke": {
            "uri": "api\/v1\/permissions\/roles\/{id}\/revoke",
            "methods": ["POST"],
            "parameters": ["id"]
        },
        "api.v1.permissions": {"uri": "api\/v1\/permissions", "methods": ["GET", "HEAD"]},
        "api.v1.permissions.store": {"uri": "api\/v1\/permissions", "methods": ["POST"]},
        "api.v1.permissions.update": {"uri": "api\/v1\/permissions\/{id}", "methods": ["PATCH"], "parameters": ["id"]},
        "api.v1.permissions.delete": {"uri": "api\/v1\/permissions\/{id}", "methods": ["DELETE"], "parameters": ["id"]},
        "api.v1..manufacturer.index": {"uri": "api\/v1\/manufacturer", "methods": ["GET", "HEAD"]},
        "api.v1..manufacturer.store": {"uri": "api\/v1\/manufacturer", "methods": ["POST"]},
        "api.v1..manufacturer.show": {
            "uri": "api\/v1\/manufacturer\/{manufacturer}",
            "methods": ["GET", "HEAD"],
            "parameters": ["manufacturer"]
        },
        "api.v1..manufacturer.update": {
            "uri": "api\/v1\/manufacturer\/{manufacturer}",
            "methods": ["PUT", "PATCH"],
            "parameters": ["manufacturer"]
        },
        "api.v1..manufacturer.destroy": {
            "uri": "api\/v1\/manufacturer\/{manufacturer}",
            "methods": ["DELETE"],
            "parameters": ["manufacturer"]
        },
        "api.v1..models.index": {"uri": "api\/aircraft\/models", "methods": ["GET", "HEAD"]},
        "api.v1..models.store": {"uri": "api\/aircraft\/models", "methods": ["POST"]},
        "api.v1..models.show": {
            "uri": "api\/aircraft\/models\/{model}",
            "methods": ["GET", "HEAD"],
            "parameters": ["model"]
        },
        ...
        "api.v1..aircraft.index": {"uri": "api\/aircraft", "methods": ["GET", "HEAD"]},
        "api.v1..aircraft.store": {"uri": "api\/aircraft", "methods": ["POST"]},
        "api.v1..aircraft.show": {
            "uri": "api\/aircraft\/{aircraft}",
            "methods": ["GET", "HEAD"],
            "parameters": ["aircraft"]
        },
        "api.v1..aircraft.update": {
            "uri": "api\/aircraft\/{aircraft}",
            "methods": ["PUT", "PATCH"],
            "parameters": ["aircraft"]
        },
        "api.v1..aircraft.destroy": {
            "uri": "api\/aircraft\/{aircraft}",
            "methods": ["DELETE"],
            "parameters": ["aircraft"]
        },
        "api.v1..flight_hours.index": {"uri": "api\/aircraft\/flight_hours", "methods": ["GET", "HEAD"]},
        "api.v1..flight_hours.store": {"uri": "api\/aircraft\/flight_hours", "methods": ["POST"]},
        "api.v1..flight_hours.show": {
            "uri": "api\/aircraft\/flight_hours\/{flight_hour}",
            "methods": ["GET", "HEAD"],
            "parameters": ["flight_hour"]
        },
        "api.v1..flight_hours.update": {
            "uri": "api\/aircraft\/flight_hours\/{flight_hour}",
            "methods": ["PUT", "PATCH"],
            "parameters": ["flight_hour"]
        },
        "api.v1..flight_hours.destroy": {
            "uri": "api\/aircraft\/flight_hours\/{flight_hour}",
            "methods": ["DELETE"],
            "parameters": ["flight_hour"]
        },
