...
import {router, useForm as useFormInertia} from "@inertiajs/vue3";
import {route} from "ziggy-js";
import moment from "moment";
import {useToast} from "vue-toastification";

export const useCamoStore = defineStore(
    "camos",
    () => {
        ...
        const afterTo = computed(() => {
            const date = moment(camoForm.start_date).toDate();
        ...
        const editActivity = (index) => {
            ...
            activity.labor_rate_id = data.labor_rate_id;
            ...
            activity.estimate_time = data.estimate_time;
